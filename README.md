...
Supports 12345 and 12345-6789 formats via Regex.

**Expiry Check:** 

Validates MM/YY format and ensures the card is not expired.

Mobile Ready: 

Uses inputmode to trigger numeric keypads on mobile devices.
...
Allows for full localization of titles, placeholders, and error messages.
